export const content = {
    ...
    FORKLIFT:{
        TITLE:"AUTOMATIC FORKLIFT HORN CONTROL TECHNOLOGY",
        FIELD:{
        ...
        OBJECT:{
            ...
            CONTENT: "The primary object of the present invention is to provide the system and method for automatic forklift horn control for the purpose of reducing the accidents in the workplaces.<br /><br /> Another object of the present invention is to provide the system which is based on a technology that can reduce operator’s load so that the operator can concentrate on their driving and their work.<br /><br />Yet another object of the present invention is to provide a system which can take care of the honking mechanism of the forklifts, that can in turn prevent accidents and save thousands of lives.<br /><br />To achieve the above object, the present invention in a first aspect provides an automatic forklift horn control system comprising of a horn; a first system including weight or pressure sensors connected to the said horn or buzzer which will be initiating the horn or buzzer once the forklift is on the designated area where the weight sensor is placed; second system including proximity sensors to identify that forklift is coming towards the blind spot; a buzzer which is initiated by the sensor when the forklift reaches the blind spot; and the third system including a copper rod connected to the ground which energizes the forklift horn when it passes over, wherein, in the forklift is accommodated with the said systems, which aide in prevention of the risks associated with operation of the said forklift.<br /><br />In accordance with the preferred embodiment of the present invention, the horn component of the forklift system is combined with the weight or pressure sensors wherein, when the said forklift reaches the blind spot, then the horn or the buzzer which is connected to the weight or pressure sensors gets initiated, where the said weight or pressure sensor generates a digital signal which in turn initiates the horn or buzzer.<br /><br />In accordance with the preferred embodiment of the present invention, the horn component of the forklift system is combined with the proximity sensors wherein, the said proximity sensors which are installed at the blind spots, senses the forklift is coming towards the blind spot, which when reaches the blind spot, the said proximity sensor is activated generating a digital signal which activates the horn or buzzer.<br /><br />In accordance with the preferred embodiment of the present invention, the horn of the forklift system is connection with the metal connectors; and a copper rod or plate wherein, the said copper rod or plate which is installed at the blind spots, senses the metal connectors installed on the forklift vehicle is coming towards the blind spot, which when reaches the blind spot, the said copper rod or plate energizes the forklift horn to produce a sound which is of very high frequency.<br /><br />According to the present invention, the said sensors can be installed at any place where the use of forklifts are at a fast pace or in a routine basis, and the accidents which are caused at such places can eb averted. As the horn blares automatically and does not involve any human intervention, in case the operator misses to horn at a turning or anu such area where the probability of causing accidents are higher, then present invention does the same by triggering the horn automatically with the help of the said sensors. Thus, operators’ safety can be assured."
